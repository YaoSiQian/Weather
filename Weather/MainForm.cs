...
namespace Weather
{
    public partial class MainForm : Form
    {
        ...
        {
            MessageBox.Show($"天气预报\r\n版本：{Assembly.GetExecutingAssembly().GetName().Version.ToString()}\r\n作者：姚思谦\r\n本程序仅用于参与《2022年铜陵市学生信息素养提升实践活动》\r\n程序图标源于 Apple\r\n天气信息源于 中国天气网","信息",MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
        ...
        private void buttonWCN_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("http://weather.com.cn");
        }
    }
}
